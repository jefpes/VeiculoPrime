...
enum Permission: string
{
    ...
    case SUPPLIER_PHOTO_CREATE  = 'supplier_photo_create';
    case SUPPLIER_PHOTO_READ    = 'supplier_photo_read';
    case SUPPLIER_PHOTO_UPDATE  = 'supplier_photo_update';
    ...
    case EMPLOYEE_PHOTO_CREATE  = 'employee_photo_create';
    case EMPLOYEE_PHOTO_READ    = 'employee_photo_read';
    case EMPLOYEE_PHOTO_UPDATE  = 'employee_photo_update';
